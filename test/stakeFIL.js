...
async function main() {
  ...
  const contractAddress = "0x677df0cb865368207999F2862Ece576dC56D8dF6"; // Replace with the actual contract address
  ...
  const nameDetails = await contract.getNameDetails("DummyName9");
